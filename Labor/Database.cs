    ...
    public sealed class Database
    {
            ...
            catch
            {
                ...
                //try
                {
                    ...
                    SqlCommand command = new SqlCommand(
                            ...
                            "CREATE TABLE L_FOGLAL (FONEVE varchar(30), FOSZAM int IDENTITY(1,1), FODATE varchar(20), FOTIPU varchar(10), FOFENE varchar(31), FOTEKO varchar(3), FOSARZT varchar(3), FOSARZI varchar(3), FOHOSZT varchar(4)," +
        ...
        public bool Hordók_Törlés(Vizsgálat.Azonosító _azonosító)
        {
            lock (LaborLock)
            {
                laborconnection.Open();
                SqlCommand command = laborconnection.CreateCommand();
                command.CommandText = "DELETE FROM L_HORDO WHERE HOTEKO = '" + _azonosító.termékkód  + "' AND HOSARZ= '" + _azonosító.sarzs + "';";
                command.ExecuteNonQuery();
                command.Dispose();
                laborconnection.Close();
            }
