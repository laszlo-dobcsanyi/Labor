...
namespace Labor
{
    public struct Foglalás
    {
        ...
        {
            public string foglalás_neve;
            public int? foglalás_száma;

            public Azonosító(int? _foglalás_száma, string _foglalás_neve)
            {
                foglalás_neve = _foglalás_neve;
        ...
        {
            public int? min_sarzs = null;
            public int? max_sarzs = null;
            public int? min_hordószám = null;
            public int? max_hordószám = null;

            public double? min_brix = null;
            public double? max_brix = null;
            public double? min_citromsav = null;
            public double? max_citromsav = null;
            public double? min_borkősav = null;
            public double? max_borkősav = null;
            public double? min_ph = null;
            public double? max_ph = null;
            public double? min_bostwick = null;
            public double? max_bostwick = null;

            public int? min_aszkorbinsav = null;
            public int? max_aszkorbinsav = null;
            public int? min_nettó_töltet = null;
            public int? max_nettó_töltet = null;
            public int? min_hőkezelés = null;
            public int? max_hőkezelés = null;
            public int? min_citromsav_ad = null;
            public int? max_citromsav_ad = null;
            public int? min_szita_átmérő = null;
            public int? max_szita_átmérő = null;
        ...
        public Foglalás(Azonosító _azonosító, Adatok1 _adatok1, Adatok2 _adatok2)
        {
    ...
    public sealed class Panel_Foglalások : Control
    {
        ...
        public sealed class Foglalás_Hozzáadás : Form
        {
            ...
            {
                /*
                 "Foglalás száma", System.Type.GetType("System.String")));
            data.Columns.Add(new DataColumn("Foglalás neve", System.Type.GetType("System.String")));
            data.Columns.Add(new DataColumn("Foglalt hordók száma", System.Type.GetType("System.Int32")));
            data.Columns.Add(new DataColumn("Foglalás típusa", System.Type.GetType("System.String")));
            data.Columns.Add(new DataColumn("Készítette", System.Type.GetType("System.String")));
            data.Columns.Add(new DataColumn("Foglalás ideje", System.Type.GetType("System.String")));
                ...
                Label foglalás_neve = Program.mainform.createlabel("Foglalás neve:", 8, 2 * 32, this);
                Label foglalt_hordók = Program.mainform.createlabel("Foglalt hordók száma:", 8, 3 * 32, this);
                Label foglalás_típusa = Program.mainform.createlabel("Foglalás típusa:", 8, 4 * 32, this);
                Label készítette = Program.mainform.createlabel("Készítette:", 8, 5 * 32, this);
                Label foglalás_ideje = Program.mainform.createlabel("Foglalás ideje:", 8, 6 * 32, this);
                ...
                TextBox box_készítette = Program.mainform.createtextbox(box_foglalás_neve.Location.X, készítette.Location.Y, 10, 160, this);
        ...
        public sealed class Foglalás_Keresés:Form
        {
            ...
            private void Keresés_Rendben(object sender, EventArgs e)
            {
                ...
                Foglalás.Azonosító azonosító = new Foglalás.Azonosító(0,"TODO");
                Foglalás.Adatok1 adatok1 = new Foglalás.Adatok1
                    (
                ...
                Foglalás.Adatok2 adatok2 = new Foglalás.Adatok2
                    (
                ...
                Foglalás adat = new Foglalás(azonosító, adatok1, adatok2);

                Keresés_Eredmény keresés_eredmény = new Keresés_Eredmény(adat);
            ...
            public sealed class Keresés_Eredmény : Form
            {
                ...
                public Keresés_Eredmény(Foglalás _eredeti)
                {
                    eredeti = _eredeti;
                    InitializeForm();
                    InitializeContent();
                ...
                {
                    Eredmény_Hordók eredmény_hordók = new Eredmény_Hordók();
                ...
                public sealed class Eredmény_Hordók : Form
                {
                    ...
                    private void InitializeContent()
                    {
                        ...
                        kijelölés_megfordítása.Location = new Point(ClientRectangle.Width - kijelölés_megfordítása.Size.Width - rögzítés.Width - 32, ClientRectangle.Height - kijelölés_megfordítása.Size.Height - 16);
