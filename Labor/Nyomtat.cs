...
namespace Labor
{
    ...
    public sealed class Nyomtat
    {
        ...
        public static void
        MinBizDataTable(Node_MinosegBizonylat _data, KonszignacioSzallitolevel _szállítólevél, int i, Table table)
        {
            int c;
            if (_szállítólevél.Nyelv == "M")
            {
        ...
        KonszignacioDataTableFormazas(Table _table)
        {
            ...
            {
                _table.Rows[i].Cells[0].Width = 45;
                _table.Rows[i].Cells[1].Width = 180;
                _table.Rows[i].Cells[2].Width = 60;
                _table.Rows[i].Cells[3].Width = 50;
                _table.Rows[i].Cells[4].Width = 80;
                _table.Rows[i].Cells[5].Width = 130;
                _table.Rows[i].Cells[6].Width = 110;
            }
            _table.AutoFit = AutoFit.ColumnWidth;
